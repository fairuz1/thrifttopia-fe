    ...
    */
    ...
    public function login(Request $request)
    {
        ...
        if (isset($authData['data']['token'])) {
            ...
            $successLogin = "
            <div class='alert alert-primary d-flex align-items-center alert-dismissible fade show m-4' style='z-index: 9999; position: absolute !important; width: 100%' role='alert'>
